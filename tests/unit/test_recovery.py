...
Two features share this file because they answer the same question from
different ends: the restart sweep asks what the process owes an intent it
abandoned, confirmation expiry asks what a token still authorises. Both were
unexpressable in V0 — not scenarios it got wrong, but scenarios it could
not be wrong about, because it kept nothing to check against.
"""
...
def test_a_crash_mid_payment_is_resolved_by_the_sweep_and_pays_once() -> None:
    """The whole point of the restart sweep, end to end.
...
# --------------------------------------------------------------------------
# The action cannot change under the token
# --------------------------------------------------------------------------
...
# --------------------------------------------------------------------------
# The sweep actually runs at boot
# --------------------------------------------------------------------------
