...
It is the seam, not the answer. The AWS deployment uses a Cognito JWT instead
(``trail.jwt_identity``), verified at the same point in ``trail.app`` — a
different :func:`verify`, the same one line of plumbing behind it.
"""
